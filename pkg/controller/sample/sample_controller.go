...
import (
	...
	samplev1alpha1 "github.com/renatoaguimaraes/k8s-sample-operator/pkg/apis/sample/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &samplev1alpha1.Sample{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &samplev1alpha1.Sample{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSample) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &samplev1alpha1.Sample{}
...
func newPodForCR(cr *samplev1alpha1.Sample) *corev1.Pod {
